...
const REQUEST_CONFIG = { timeout: 30000 };
const auth = () => ({
    ...REQUEST_CONFIG,
...
export const getPublicHelpArticles = () => axios.get(`${API}/public/articles`, REQUEST_CONFIG);
export const askPublicZarvis = (question, history = [], language = "auto") =>
    axios.post(`${API}/public/zarvis/ask`, { question, history, language }, REQUEST_CONFIG);
...
export const replyHelpTicket = (id, message) =>
    axios.post(`${API}/tickets/${id}/reply`, { message }, auth());
...
export const getAdminHelpTickets = (status = "all") =>
    axios.get(`${API}/admin/tickets`, { ...auth(), params: { status } });
export const updateAdminHelpTicket = (id, payload) =>
    axios.put(`${API}/admin/tickets/${id}`, payload, auth());
