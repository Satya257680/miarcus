...
const EmployeeLocation = () => {
    ...
    const mapUrl = useMemo(() => {
        ...
        if (selected.latitude == null || selected.longitude == null) {
            return "https://www.openstreetmap.org/export/embed.html?bbox=73.80%2C18.48%2C73.98%2C18.60&layer=mapnik";
        }
    ...
    return (
        <div className="employee-location-page">
                    ...
                    {selected ? (
                        <>
                            ...
                            <div className="detail-list">
                                ...
                                <div><span>Last website update</span><strong>{selected.last_update ? new Date(selected.last_update).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit" }) : "—"}</strong></div>
                            </div>
            ...
            <section className="privacy-grid">
                <div className="privacy-card green"><FaClock /><div><h3>Working Hours</h3><p>Tracking window: <b>09:00 AM – 09:00 PM</b>, Asia/Kolkata.</p><span>Outside this window, the website must not collect location.</span></div></div>
                ...
                <div className="privacy-card blue"><FaSignal /><div><h3>Website Location</h3><p>Current mode: <b>Browser / website location</b>.</p><span>Location is captured from the employee’s browser while they are signed in to the MIARCUS website. Last known location remains visible when a new update is unavailable.</span></div></div>
            </section>
        </div>
    );
};
