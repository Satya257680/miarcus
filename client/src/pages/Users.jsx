...
<BulkUploadModal
  ...
  // pages/ChecklistReports.jsx / pages/ActionPoints.jsx), so a single
  // request here is still limited in practice to whatever fits under
  // IIS's own ~4 GB per-request ceiling (server/web.config).
