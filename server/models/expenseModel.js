...
// ======================================================
// MI ARCUS EXPENSE MODEL
// ======================================================
// The db wrapper already unwraps mysql2's [rows, fields]
// and [result, fields] into the first value. Therefore all
// async calls below intentionally use:
//
...
const Expense = {
    ...
    async getTypes() {
        ...
        return Array.isArray(rows)
            ? rows.map((row) => row.expense_type).filter(Boolean)
            : [];
    }
};
